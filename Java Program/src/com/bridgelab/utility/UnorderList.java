...
public class UnorderList<T> 
{
 ...
 public <T extends Comparable<T>>void add(T data)
 {
  ...
  for(previous=null,forword=start;forword!=null && data.compareTo((T) forword.data)>0;previous=forword,forword=forword.next);
  if(forword==null)
  {
   if(start==null)
   {
 ...
 public void remove(T data)
 {
  ...
  for(forword=start,previous=null;!data.equals(forword.data) && forword!=null;previous=forword,forword=forword.next);
...
*/ }
 ...
 public void insert(int pos,T data)
 {
  ...
  if(forword==null) System.out.println("List is Empty...!");;
